export const quizData = {
    Internal_Developer_Portal: [
        {
            id: 1,
            question: "You're a developer who needs to find information about a microservice called 'payment-service' in your organization.\nWhich IDP feature would you use to discover this service and its documentation?",
            options: [
                "Workflows",
                "Software Catalog",
                "Scorecards",
        ...
        {
            id: 2,
            question: "Your team frequently needs to create new microservices with the same boilerplate code and configuration.\nWhat IDP feature can automate this repetitive process?",
            options: [
                "Scorecards",
                "Developer Dashboard",
        ...
        {
            id: 4,
            question: "Your organization wants to track which services have proper documentation, security scans, and follow coding standards.\nWhich IDP feature helps measure and track these organizational metrics?",
        ...
        {
            id: 5,
            question: "You need to ensure that only certain team members can execute critical workflows or modify specific catalog entities.\nWhat IDP capability manages these permissions?",
        ...
        {
            id: 6,
            question: "How can platform administrators track how well teams are adopting and using the IDP?",
